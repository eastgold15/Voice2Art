...
| PR6 | JSON 指令执行器 `executeInstructions()` + 坐标网格 | B | ✅ |
| PR7 | 混合模式：正则优先 + LLM 降级 + Toast 错误提示 | A+B | ✅ |
| PR8 | 导出 PNG + 设计文档 + README + Demo 视频 | A+B | 🏗️ |

> PR8 进行中：PNG 导出已实现✅，打磨和文档更新中。
